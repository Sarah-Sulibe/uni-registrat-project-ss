...
public class MainTest {
    ...
    public void testenterGrade() {
        raafat.assignStudentToCourse(studentList.get(0), courseList.get(0),
                courseList.get(0).getCourseOfferSemester().get(0));
    ...
    public void testGenerateAcademicsReport() {
        raafat.assignStudentToCourse(studentList.get(0), courseList.get(0),
                courseList.get(0).getCourseOfferSemester().get(0));
        raafat.assignStudentToCourse(studentList.get(0), courseList.get(2),
                courseList.get(2).getCourseOfferSemester().get(0));
        ...
        // Split the output into lines for comparison
        String[] actualOutputLines = outContent.toString().split("\\n");
        Arrays.sort(actualOutputLines);

        // Expected lines (sorted)
        String[] expectedOutputLines = new String[] {
                "Academic Report for Alice Smith in Spring2023:",
        ...
        Arrays.sort(expectedOutputLines);

        Assert.assertArrayEquals(expectedOutputLines, actualOutputLines);
    }
    ...
    public void testassignStudentToCourse() {
        ...
        boolean result = raafat.assignStudentToCourse(studentList.get(0), courseList.get(1),
                courseList.get(0).getCourseOfferSemester().get(0));
    ...
    public void testassignStaffToCourse() {
        boolean firstAssignmentResult = raafat.assignCourseToStaff(staffList.get(0), courseList.get(0),
                courseList.get(0).getCourseOfferSemester().get(0));
        assertEquals(true, firstAssignmentResult);

        boolean secondAssignmentResult = raafat.assignCourseToStaff(staffList.get(0), courseList.get(0),
                courseList.get(0).getCourseOfferSemester().get(0));
    ...
    @Test
    public void rr() {
        boolean firstAssignment = raafat.assignStudentToCourse(studentList.get(0), courseList.get(0),
                courseList.get(0).getCourseOfferSemester().get(0));

        boolean secondAssignment = raafat.assignStudentToCourse(studentList.get(0), courseList.get(0),
                courseList.get(0).getCourseOfferSemester().get(0));
